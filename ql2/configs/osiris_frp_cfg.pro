...
struct={ cconfigs, $
         cfg_name:'OSIRIS FRP', $ ; instrument configuration
         ...
         poll_dir:'~/osiris/spec_frp', $ ; set the initial polling directory
         ...
         conbase_dir:'~/osiris/spec_frp', $ ; set the initial conbase directory
         draw_xs:512., $
         draw_ys:512., $
         ...
         imscalemaxcon:5., $
         imscalemincon:-3., $
         flip:1, $ ; flip the display image if required for N=up, E=left
         displayasdn:'As DN/s', $
