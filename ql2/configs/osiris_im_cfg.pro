...
struct={ cconfigs, $
         cfg_name:'OSIRIS IMAG', $ ; instrument configuration
         ...
         poll_dir:'~/osiris/imag_raw', $ ; set the initial polling directory
         ...
         conbase_dir:'~/osiris/imag_raw', $ ; set the initial conbase directory
         draw_xs:512., $
         draw_ys:512., $
